...
public class ThreadUtilCsv2 extends Thread {

    private long thread2TIme;
    public ThreadUtilCsv2(long thread2TIme) {
        this.thread2TIme = thread2TIme;
    }

   /* public double getthread2TIme() {
        return thread2TIme;
    }*/
    @SneakyThrows
    @Override
    public void run()  {
        ...
        try {
            ...
            //out.write("\n");
            out.write(populateFileData(2, 2, "Imtiyaz"));
